	...
	Alpine.store("lang", {
		...
		dictionaries: {
			en: {
				...
				about_desc: "A student with a strong interest and enthusiasm for development in technology. Dedicated to software development to create relevant solutions to problems in the digital world using modern, efficient technologies such as Tailwind CSS, AlpineJS, and Laravel. Proven by 12 GitHub repositories and over 300 contributions.",
			...
			id: {
				...
				about_desc: "Seorang siswa dengan minat dan antusiasme tinggi untuk berkembang di bidang teknologi. Berdedikasi pada pengembangan perangkat lunak guna menciptakan solusi yang relevan untuk masalah di dunia digital dengan teknologi modern yang efisien seperti Tailwind CSS, AlpineJS, dan Laravel. Dibuktikan dengan 12 repository GitHub dan 300+ contribution.",
		...
		data: {
			en: {
				...
				experiences_org: [
					{ title: "OSIS SMK Al-Khoeriyah", type: "Head of Section IX (ICT)", year: "2024-2025", logo: "src/img/org/osis.webp" },
					{ title: "Jurnalis SMK Al-Khoeriyah", type: "Editor", year: "2024-2025", logo: "src/img/org/jurnalis.webp" },
					{ title: "TIK SMK Al-Khoeriyah", type: "Extracurricular Club Leader", year: "2024-2025", logo: "src/img/org/tik.webp" },
					{ title: "OSIS SMK Al-Khoeriyah", type: "Member of Section IX (ICT)", year: "2023-2024", logo: "src/img/org/osis.webp" },
				],
				experiences_award: [],
			},
			id: {
				...
				experiences_org: [
					{ title: "OSIS SMK Al-Khoeriyah", type: "Ketua Sekbid IX (TIK)", year: "2024-2025", logo: "src/img/org/osis.webp" },
					{ title: "Jurnalis SMK Al-Khoeriyah", type: "Editor", year: "2024-2025", logo: "src/img/org/jurnalis.webp" },
					{ title: "TIK SMK Al-Khoeriyah", type: "Ketua Ekstrakurikuler", year: "2024-2025", logo: "src/img/org/tik.webp" },
					{ title: "OSIS SMK Al-Khoeriyah", type: "Anggota Sekbid IX (TIK)", year: "2023-2024", logo: "src/img/org/osis.webp" },
				],
				experiences_award: [],
			},
		},
