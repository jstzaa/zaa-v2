		...
		data: {
			en: {
				...
				portfolios: [
					...
					{ name: "Company Profile CV. Access Media", desc: "Create a company profile website", foto: "src/img/porto/porto7.png" },
					...
					{ name: "UI Design Digilib", desc: "UI Design Digital Library SMK Al-Khoeriyah", foto: "src/img/porto/porto4.png" },
				...
				experiences_work: [{ title: "CV. Access Media", type: "Field Work Practice", year: "2025-2026", logo: "src/img/work/acm.png", desc: "", tasks: ["Create a company landing page"] }],
				experiences_org: [
			...
			id: {
				...
				experiences_work: [{ title: "CV. Access Media", type: "Praktik Kerja Lapangan", year: "2025-2026", logo: "src/img/work/acm.png", desc: "", tasks: ["Membuat landing page perusahaan"] }],
				experiences_org: [
